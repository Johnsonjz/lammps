...
#ifdef PAIR_CLASS
// clang-format off
PairStyle(lj/cut/tip4p/user,PairLJCutTIP4PUser);
// clang-format on
#else

#ifndef LMP_PAIR_LJ_CUT_TIP4P_USER_H
#define LMP_PAIR_LJ_CUT_TIP4P_USER_H

#include "pair_lj_cut_coul_user.h"
namespace LAMMPS_NS {

class PairLJCutTIP4PUser : public PairLJCutCoulUser {
public:
   PairLJCutTIP4PUser(class LAMMPS *);
   ~PairLJCutTIP4PUser() override;
