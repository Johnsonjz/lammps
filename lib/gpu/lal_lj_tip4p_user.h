/**************************************************************************
  ...
  Class for acceleration of the lj/tip4p/user pair style
...
#ifndef LAL_LJ_TIP4P_USER_H
#define LAL_LJ_TIP4P_USER_H
...
class LJ_TIP4PUser : public BaseCharge<numtyp, acctyp> {
public:
  LJ_TIP4PUser();
  ~LJ_TIP4PUser();
